...
<body>
	...
	<div id = "content">
	<form method = "post" onsubmit="return check()" action = "dept_modify_do.jsp">
		...
		<tr>
		<td><input type = "text" name = "deptcode" value = "<%=art.getDeptcode()%>"></td>
		<td>
		...
		<td><A href="deptRegist.jsp">수정하기</A></td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                		</TD>
		</tr>
		<%
			} // end while
		%>
