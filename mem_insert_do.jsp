...
//만일, 서버에 동일한 파일이름이 저장되어있다면, 파일이름 뒤에 숫자를 증가시킴
 ...
 String sql = "INSERT INTO member(id, filename, krname, enname, birth, gender, enterdate, enterposit, depart, position, leavedate, reason, tel, cellphone, email, address, bank, account, hostname, others )"
		 + "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
