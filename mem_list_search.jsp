...
<%
	...
	String sidx = request.getParameter("search");
...
<body>
	...
	<div id = "content">
		...
		<input type = "button" value = "퇴직자 목록" onclick="location.href = 'mem_list_leave.jsp?'">
		</form>
		<p>
...
<%
 while(rs.next()) {
	 if(sidx.equals(rs.getString("id")) || sidx.equals(rs.getString("krname"))){
%>
<TR>
